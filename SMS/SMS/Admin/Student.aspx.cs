            ...
            try
            {
                if (ddlGender.SelectedValue != "0")
                {
                    ...
                    if (dt.Rows.Count == 0)
                    {
                        ...
                        fn.Query(query);
                        ScriptManager.RegisterStartupScript(this, GetType(), "PopUp", "StudSuccess()", true);
                    ...
                    {
                        ScriptManager.RegisterStartupScript(this, GetType(), "PopUp", "StudAlEx()", true);
                    }
                }
                else
                {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                fn.Query("Update Student set Name = '" + name.Trim() + "',Mobile ='" + mobile.Trim() + "', " +
                    "Address = '" + address.Trim() + "', RollNo = '" + rollNo.Trim() + "', ClassId = '" + classId + "'  where StudentId = '" + studentId + "' ");
                ScriptManager.RegisterStartupScript(this, GetType(), "PopUp", "StudUpdt()", true);
                GridView1.EditIndex = -1;
                GetStudents();
            }
            catch (Exception ex)

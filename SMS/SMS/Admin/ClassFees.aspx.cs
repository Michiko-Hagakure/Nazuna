    ...
    public partial class ClassFees : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ScriptManager.RegisterStartupScript(this, GetType(), "PopUp", "failed1()", true);
                }
            }
            catch (Exception ex)
            {
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                ScriptManager.RegisterStartupScript(this, GetType(), "PopUp", "deleted()", true);
                GridView1.EditIndex = -1;
                GetFees();
            }
            catch(Exception ex)
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            try
            {
                ...
                ScriptManager.RegisterStartupScript(this, GetType(), "PopUp", "update1()", true);
                GridView1.EditIndex = -1;
                GetFees();
            }
            catch (Exception ex)

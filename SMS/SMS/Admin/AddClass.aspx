        ...
        <div class="row mb-3 mr-lg-5 ml-lg-5">
            <div class="col-md-4">
                <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" DataKeyNames="ClassId" AutoGenerateColumns="False"
                    ...
                    OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" EmptyDataText="No Record To Display!" AllowPaging="true" OnRowDeleting="GridView1_RowDeleting">
                    <Columns>
                        ...
                        <asp:CommandField CausesValidation="False" ShowDeleteButton="True" ShowEditButton="True" HeaderText="Operation"></asp:CommandField>
                    </Columns>

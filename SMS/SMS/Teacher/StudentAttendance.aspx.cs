    ...
    public partial class StudentAttendance : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow row in GridView1.Rows)
            {
                ...
                fn.Fetch("Insert Into StudentAttendance values ('" + ddlClass.SelectedValue + "', '" + ddlSubject.SelectedValue + "'," +
                    " '" + rollNo + "', '" + status + "' ,'" + DateTime.Now.ToString("yyyy/MM/dd") + "')");
                isTrue = true;
            }
            if(isTrue)
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "PopUp", "studAtdSuccess()", true);
            }
            else
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "PopUp", "studErr()", true);
            }
        }
